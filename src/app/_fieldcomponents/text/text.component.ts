...
/*
    switch(this.fieldComp.type) {
      case "Date Time":
        // for now, when just displayin dates, show in the format today, yesterday, 5 days ago, etc.
        // currently, return json doesn't include pega model formats
        this.formattedValue$ = moment(this.fieldComp.value.replace("GMT", "+0000"), "YYYYMMDD[T]HHmmss[.]SSS Z").fromNow();
        break;
    }
    */
